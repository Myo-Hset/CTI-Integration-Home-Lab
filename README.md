...
Creating a centralized Open Source Threat Intelligence Home Lab for easy access and utilization of open‑source threat intelligence tools, and integrating it with Splunk.
...
Generate a UUID from https://www.uuidgenerator.net/ and use it as the value for **OPEN_ADMIN_TOKEN** and the 
Other **_PASSWORD** variables set those to a password of your choice. For example, I assigned: **P@ssw0rd!**.
